        ...
        <Dialog as="div" className="relative z-50" onClose={() => setOpen(false)}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center">
              ...
              >
                <DialogPanel className="w-full max-h-[94vh] overflow-y-auto rounded-t-3xl border border-white/60 bg-white/72 p-4 shadow-[0_-12px_36px_rgba(15,23,42,0.24)] backdrop-blur-2xl">
